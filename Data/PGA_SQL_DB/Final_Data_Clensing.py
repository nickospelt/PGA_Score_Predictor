...
def clean_values(value):
    clean_value = value
    if (clean_value[0] == "\"" and clean_value is not None):
        clean_value = clean_value[1:]
        clean_value = clean_value[:-1]

    if (clean_value[len(clean_value) - 1] == "%" and clean_value is not None):
        clean_value = clean_value[:-1]

    return clean_value

master_dataset_df = pd.read_csv('/Users/nickospelt/Documents/App_Projects/PGA_Score_Predictor/Data/PGA_SQL_DB/master_pga_dataset_v4.csv')
...
master_dataset_df.to_csv('/Users/nickospelt/Documents/App_Projects/PGA_Score_Predictor/Data/PGA_SQL_DB/clean_master_pga_dataset_v4.csv', index=False)
