...
SELECT DISTINCT RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME, 
    ...
    ELEVATION, COURSE_NAME, COURSE_LOCATION, PAR, LENGTH, COURSE_AVERAGE_SCORE,
    PLAYER_ID, RAW_TOURNAMENT_ROUNDS.PLAYER_NAME,
...
FROM RAW_TOURNAMENT_ROUNDS
    INNER JOIN ROUND_1 ON RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME = ROUND_1.TOURNAMENT_NAME AND RAW_TOURNAMENT_ROUNDS.PLAYER_NAME = ROUND_1.PLAYER_NAME
    INNER JOIN ROUND_2 ON RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME = ROUND_2.TOURNAMENT_NAME AND RAW_TOURNAMENT_ROUNDS.PLAYER_NAME = ROUND_2.PLAYER_NAME
    INNER JOIN ROUND_3 ON RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME = ROUND_3.TOURNAMENT_NAME AND RAW_TOURNAMENT_ROUNDS.PLAYER_NAME = ROUND_3.PLAYER_NAME
    INNER JOIN ROUND_4 ON RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME = ROUND_4.TOURNAMENT_NAME AND RAW_TOURNAMENT_ROUNDS.PLAYER_NAME = ROUND_4.PLAYER_NAME
ORDER BY RAW_TOURNAMENT_ROUNDS.TOURNAMENT_NAME, (R1_SCORE + R2_SCORE + R3_SCORE + R4_SCORE)