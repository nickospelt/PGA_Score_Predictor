...
def aggregate_player_and_tournament_data():
    ...
    for tournament_result_csv in os.listdir(os.path.join(main_dir, 'Tournament_Results')):
        ...
        main_player_data_df = pd.merge(main_player_data_df, prox_to_hole_df, on='PLAYER_ID', how='inner')
        main_player_data_df = main_player_data_df[['PLAYER_ID', 'PLAYER_NAME', 'GIR_PERCENTAGE', 'BIRDIE_TO_BOGEY_RATIO', 'AVG_TOTAL_DRIVING_DISTANCE', 'FIR_PERCENTAGE', 'SCORING_AVERAGE', 'SCRAMBLING_PERCENTAGE', 'AVG_THREE_PUTTS_PER_ROUND', 'AVG_PUTTS_PER_ROUND', 'AVG']].rename(columns={'AVG': 'AVG_PROX_TO_HOLE'})
        


        # reorder the columns
        main_player_data_df['TOURNAMENT_NAME'] = tournament_result_csv.replace('.csv', '')
        main_player_data_df = main_player_data_df[['PLAYER_ID', 'PLAYER_NAME', 'TOURNAMENT_NAME', 'GIR_PERCENTAGE', 'AVG_PROX_TO_HOLE', 'BIRDIE_TO_BOGEY_RATIO', 'AVG_TOTAL_DRIVING_DISTANCE', 'FIR_PERCENTAGE', 'SCORING_AVERAGE', 'SCRAMBLING_PERCENTAGE', 'AVG_THREE_PUTTS_PER_ROUND', 'AVG_PUTTS_PER_ROUND']]
    ...
    'AVG_PROX_TO_HOLE', 'BIRDIE_TO_BOGEY_RATIO', 'AVG_TOTAL_DRIVING_DISTANCE', 'FIR_PERCENTAGE', 'SCORING_AVERAGE', 'SCRAMBLING_PERCENTAGE', 'AVG_THREE_PUTTS_PER_ROUND', 'AVG_PUTTS_PER_ROUND', "SCORE", "TOTAL_SCORE"]]
